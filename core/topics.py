TOPICS = {
    ...
    "Культура и искусство": ["Современное искусство", "Живопись", "Архитектура", "Фотография", "Театр", "Мода", "Культурология", "Поэзия"],
    "Книги": ["Художественная литература", "Нон-фикшн", "Фэнтези", "Научная фантастика", "Биографии", "Поэзия", "Классика"],
    ...
    "Повседневные темы": ["Отношения и знакомства", "Дружба", "Мемы и юмор", "Работа и карьера", "Увлечения", "Волонтёрство"],
    "Здоровье и спорт": ["Фитнес", "Питание", "Медитация", "ЗОЖ", "Футбол", "Баскетбол", "Бокс / ММА", "Бег и марафоны"],
